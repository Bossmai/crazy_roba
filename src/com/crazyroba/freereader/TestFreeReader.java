package com.crazyroba.freereader;
...
public class TestFreeReader extends RobaActivityInstrumentationTestCase2 {
	...
	private static final String LAUNCHER_ACTIVITY_FULL_CLASSNAME = "com.reader.freereader/.FirstActivity";
	private static final String TAG = "TestFreeReader";
	...
	public TestFreeReader() throws ClassNotFoundException {
